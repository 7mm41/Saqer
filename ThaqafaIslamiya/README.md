...
- **51 رسمًا متحركًا** لطفل يؤدي كل حركة بنفسها (غسل الوجه، المضمضة، الاستنشاق، مسح الرأس، ضرب التراب، الركوع، السجود…)، مدمجة داخل التطبيق كفيديوهات MP4 قصيرة متكررة. انظر [`Docs/animations_preview.png`](Docs/animations_preview.png).
...
├── Tools/Animations/                  مولّد الرسوم المتحركة (Python + cairo)
└── ThaqafaIslamiya/                   مجلد المصدر (متزامن مع الهدف)
    ...
    └── Assets/
        ...
        ├── Animations/                ‏55 فيديو MP4 (51 خطوة + 4 أغلفة دروس)
...
- كل بطاقة فيها: رسم متحرك لطفل يؤدي الحركة، عنوان ونص قصير، عدّاد تكرار بقطرات يلمسها الطفل (مثل «ثلاثًا»)، فقاعة الدعاء مع زر استماع، و«من الكتاب» للتفصيل.
